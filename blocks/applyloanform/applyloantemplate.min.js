                                ...
                                <div class="text">
                                    <div class="cmp-form-text">
                                        ...
                                        <div class="cmp-form-text-parent" id="dob-container">
                                            <input class="cmp-form-text__text dobclass" type="text" placeholder="${a.datePickerPlaceholder}" data-validdate=" "
