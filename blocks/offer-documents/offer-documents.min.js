import{ctaClickInteraction as p}from"../../dl.min.min.js";import{getProps as v}from"../../scripts/common.min.min.js";export default function y(a){const[c,i,l,d,u,r,m,n]=v(a,{index:[3,7]});if(m==="secondary"){a.innerHTML=`
