import{fetchPlaceholders as s,sampleRUM as d}from"./aem.min.min.js";import g from"./events.min.min.js";d("cwv"),g();function m(){"serviceWorker"in navigator?navigator.serviceWorker.register("/serviceworker.min.min.js").then(e=>{console.log("Service Worker registered.",e)}).catch(e=>{console.log("Service Worker **not** registered",e)}):console.log("Service workers are not supported in this browser.")}function u(){const e=document.createElement("script");e.innerHTML=`// Google Tag Manager 
